...
function generatePlaylist() {
    ...
    for (let i = 1; i <= 91; i++) {
        const audioFileName = `Ashtavakra_Geeta_Maha_Geeta_${String(i).padStart(2, '0')}.mp3`;
...
function initializeWebsite() {
    ...
    generatePlaylist();
      ...
      // Enhance the header typography
      const header = document.querySelector('header');
      header.style.fontFamily = 'Roboto Condensed, sans-serif'; // Example font
      header.style.textAlign = 'center';
      header.style.color = '#00ffff'; // Light blue color
      header.style.textShadow = '0 0 5px rgba(0, 255, 255, 0.7)'; // Subtle glow effect
